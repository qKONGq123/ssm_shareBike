				...
				<div :style='{"padding":"0px","boxShadow":"0px 0px 0px #eee","borderColor":"#e6e6e6","margin":"0","display":"flex","justifyContent":"space-between","overflow":"hidden","borderRadius":"4px","flexWrap":"wrap","background":"none","borderWidth":"0px","width":"100%","position":"relative","borderStyle":"solid"}'>
					...
					<div :style='{"minHeight":"540px","padding":"0 0 40px","margin":"20px 7% 0","borderColor":"#eee","background":"url(http://codegen.caihongy.cn/20230127/03ad723288d44044a8b922de0a51127f.png) no-repeat left top,url(http://codegen.caihongy.cn/20230127/e1b074885e304a40bcfa7de91c22b700.png) no-repeat center bottom,#e0edf2","borderWidth":"0px","flex":"1","width":"100%","borderStyle":"solid","order":"1"}'>
						...
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>车辆品牌：</div>
						...
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>车牌号码：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","background":"none"}' class="desc">
								{{detail.chepaihaoma}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>租赁价格：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","background":"none"}' class="desc">
								{{detail.zulinjiage}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>车辆状态：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","background":"none"}' class="desc">
								{{detail.cheliangzhuangtai}}
							</div>
						</div>
						<div :style='{"padding":"0px","margin":"0 auto 10px","borderColor":"#abd0e3","background":"none","borderWidth":"0px 0px 1px","display":"flex","width":"90%","borderStyle":"dashed","justifyContent":"spaceBetween"}' class="detail-item">
							<div :style='{"padding":"0 10px 0 0","color":"#278bc0","textAlign":"right","background":"none","width":"auto","fontSize":"16px","lineHeight":"40px","minWidth":"130px","height":"40px"}'>车身颜色：</div>
							<div  :style='{"width":"100%","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#333","background":"none"}' class="desc">
								{{detail.cheshenyanse}}
							</div>
						</div>
				...
				<div class="layui-tab layui-tab-card" :style='{"minHeight":"500px","padding":"0","boxShadow":"none","margin":"20px 7% 0","borderColor":"#e6e6e6","overflow":"hidden","borderRadius":"0px","background":"#fff","borderWidth":"0px","width":"100%","borderStyle":"solid","order":"10"}'>
					...
					<div :style='{"padding":"15px","background":"#fff"}' class="layui-tab-content">
						...
						<div class="layui-tab-item layui-show">
							<div v-html="detail.cheliangjieshao"></div>
						</div>
		...
		<script>
					...
					storeUp() {
						layui.http.request('storeup/list', 'get', {
							...
							layui.http.requestJson('storeup/save', 'post', {
								...
								name: this.title,
							    type:1,
                                inteltype: vue.detail.cheliangpinpai,
								picture:vue.detail.cheliangtupian.split(",")[0],
								refid: this.detail.id,
								tablename: this.detailTable
							}, function(res) {
								layer.msg('收藏成功', {
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					...
					// 轮播图片
					vue.swiperList = vue.detail.cheliangtupian ? vue.detail.cheliangtupian.split(",") : [];
					// 轮播图
					vue.$nextTick(() => {
						carousel.render({
							elem: '#swiper',
